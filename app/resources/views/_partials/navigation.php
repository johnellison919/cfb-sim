		...
		<ul class="navbar-nav">
			...
			<li class="nav-item dropdown">
				...
				<ul class="dropdown-menu">
					<li>
						<a class="dropdown-item" href="/news/recent-news/">Recent News</a>
					</li>
					<li>
						<a class="dropdown-item" href="/news/top-25-polls/">Top 25 Polls</a>
					</li>
					<li>
						<a class="dropdown-item" href="/news/scores-and-schedules/">Scores & Schedules</a>
					</li>
					<li>
						<a class="dropdown-item" href="/news/conference-standings/">Conference Standings</a>
					</li>
					<li>
						<a class="dropdown-item" href="/news/bowls/">Bowl Predictions</a>
					</li>
					<li>
						<a class="dropdown-item" href="/news/all-emericans/">All-Americans</a>
					</li>
					<li>
						<a class="dropdown-item" href="/news/awards/">Award Winners</a>
					</li>
				</ul>
			</li>
			<li class="nav-item dropdown">
